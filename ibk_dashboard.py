...
<div class="panel uc-card" style="border-left-color:#e8560a"><div class=uc-header><h2>${ucIcon('clock')}Iste'mol muddati tahlili</h2>${yarSt}</div><div class=uc-note>yaroqlilik_muddati_tahlili.xlsx yoki yaroqlilik_1_oy_ichida.xlsx — muddati o'tgan va yaqinda tugaydigan tovarlar.</div><div class=uc-body style="margin-top:12px"><div class=uc-field><label>Yaroqlilik Excel fayli</label><input type=file id="ucYarFile" accept=".xlsx,.xls,.zip,.rar"></div><div class=uc-btns><button onclick="ucUploadYaroqlilik(this)">Yuklash</button></div></div><div class=muted id="ucYarStatus" style="margin-top:8px"></div></div>
